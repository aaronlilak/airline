 ...
 * code.
 */
public class myAirportnames {

    /** The singleton instance of AirportNames */
    private static myAirportnames myairportNames = null;
    ...
    public static String getName(String code) {
        if (myairportNames == null) {
            myairportNames = new myAirportnames();
        }

        return myairportNames.names.get(code);
    }
    ...
    public static void main(String[] args) {
        for ( String arg : args ) {
            String name = myAirportnames.getName( arg );
